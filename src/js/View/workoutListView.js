...
⚠️ <br />Only Positive Numbers are permitted unless elevation field. <br />
  ...
  btnsMenu = document.querySelector(".btns-menu");
  btnOverview = document.querySelector(".btn-overview");
  btnSort = document.querySelector(".btn-sort");
  sortBar = document.querySelector(".sort-bar");
  deleteAllWorkoutBtn = document.querySelector(".btn-reset");
  ...
  _generateMarkupCycling(workout) {
    return `
      <div class="workout__details">
        ...
        <span class="workout__value workout__value--speed">
